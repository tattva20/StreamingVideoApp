...
extension VideosUIIntegrationTests {
	...
	class LoaderSpy {
		...
		private var videoLoader = TattvaTests.LoaderSpy<Void, Paginated<Video>>()
		...
		private var loadMoreLoader = TattvaTests.LoaderSpy<Void, Paginated<Video>>()
		...
		private var imageLoader = TattvaTests.LoaderSpy<URL, Data>()
